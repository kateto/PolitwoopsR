...
The PolitwoopsR package includes functions that extract tweet data from any <a href="http://politwoops.com/"  target="_blank">Politwoops</a> project. It also provides a way to scrape politician data from the <a href="http://politwoops.sunlightfoundation.com"  target="_blank">US Politwoops project</a>.
